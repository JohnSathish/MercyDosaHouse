...
const productionEnv = {
  ...
  EXPO_PUBLIC_ADMIN_URL: process.env.EXPO_PUBLIC_ADMIN_URL || 'https://admin.mercydosahouse.com',
};
...
if (!fs.existsSync(path.join(root, 'android'))) {
  console.error('android/ folder missing. Run Expo prebuild first.');
  process.exit(1);
}
...
console.log('Android bundle ready.');
