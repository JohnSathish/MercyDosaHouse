...
export function AdminTopbar({
  ...
  return (
    <header className="h-14 border-b bg-white/95 dark:bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 dark:supports-[backdrop-filter]:bg-gray-900/80 dark:border-gray-800 flex items-center gap-3 px-4 lg:px-6 xl:px-8 shrink-0 sticky top-0 z-30 w-full">
      {/* Mobile brand */}
      <div className="flex items-center gap-2 md:hidden shrink-0">
        {brandLoading ? (
          <div className="h-8 w-8 rounded-lg bg-muted animate-pulse" />
        ) : (
          <div className="relative h-8 w-8 rounded-lg overflow-hidden ring-1 ring-[#14532D]/20">
            <Image
              src={brand.logoUrl}
        ...
        <span className="text-sm font-semibold truncate max-w-[120px]">{brand.businessName}</span>
      </div>
      ...
      <div className="relative">
        ...
        {notifOpen && (
          <>
            ...
            <div className="absolute right-0 top-full mt-1 w-80 bg-white dark:bg-gray-900 rounded-xl shadow-xl border dark:border-gray-700 z-50 overflow-hidden">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 rounded-lg pl-2 pr-1 py-1 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
        >
