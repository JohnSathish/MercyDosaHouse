...
export default async function ContactPage() {
  const [settings, marketing] = await Promise.all([fetchBusinessSettings(), getMarketingBundle()]);
    ...
    <div className="bg-[#FDF8F4] min-h-[calc(100vh-12rem)]">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-10 lg:gap-14 items-start max-w-6xl mx-auto">
          <ContactInfoPanel settings={settings} delivery={marketing.delivery} />
          <ContactForm />
        </div>
      </div>
    </div>
...
export const metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Mercy Dosa House — phone, WhatsApp, email, or send us a message.',
};
